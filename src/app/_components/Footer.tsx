...
const Footer = () => {
    return (
        <footer className="text-white py-8 mt-10
            ...
            dark:bg-gradient-to-l dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 shadow-inner">
                ...
                <div className="flex flex-wrap justify-between ">
                    ...
                    <div className="w-full md:w-1/3 mb-6 md:mb-0">
                        ...
                        <ul className="mt-4 space-y-2">
                            <li><a href="#" className="hover:underline dark:text-gray-400">About Us</a></li>
                            <li><a href="#" className="hover:underline dark:text-gray-400">Services</a></li>
                            <li><a href="#" className="hover:underline dark:text-gray-400">Contact</a></li>
                            <li><a href="#" className="hover:underline dark:text-gray-400">Privacy Policy</a></li>
                        </ul>
                    </div>
                    {/* Contact Info */}
                    <div className="w-full md:w-1/3 mb-6 md:mb-0">
