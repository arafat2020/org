...
INSERT INTO "new_Product" ("catagoryId", "description", "id", "name", "primaryImg", "published", "subCategoryId") SELECT "catagoryId", "description", "id", "name", "primaryImg", "published", "subCategoryId" FROM "Product";
DROP TABLE "Product";
